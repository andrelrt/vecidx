...
{
    bench<vecidx::search_index, uint64_t>( "vecidx::search_index, uint64", 10, 1 );
    bench<vecidx::search_index, uint64_t>( "vecidx::search_index, uint64", 15, 1 );
    //bench<vecidx::search_index, uint64_t>( "vecidx::search_index, uint64", 31, 1 );
    //bench<vecidx::search_index, uint64_t>( "vecidx::search_index, uint64", 63, 1 );
    //bench<vecidx::search_index, uint64_t>( "vecidx::search_index, uint64", 127, 1 );

    //for( size_t size = 2; size < 0x2000'0000; size <<= 1 )
    //{
    //    std::cout << "\nsize: 0x" << std::hex << size - 1 << "\n\n";
    //    std::cerr << "size: 0x" << std::hex << size - 1 << "\n";
    //    bench<vecidx::vector_index, uint32_t>( "vecidx::vector_index, uint32", size-1, 1 );
    //    bench<vecidx::vector_index, uint64_t>( "vecidx::vector_index, uint64", size - 1, 1 );

    //    std::cout << "\n";
    //    bench<vecidx::search_index, uint32_t>( "vecidx::search_index, uint32", size - 1, 1 );
    //    bench<vecidx::search_index, uint64_t>( "vecidx::search_index, uint64", size - 1, 1 );
    //}
    ...
    //{
    //    std::cout << "\nsize: 0x00ff'ffff\n\n";
    //    bench<vecidx::vector_index, uint32_t>( "vecidx::vector_index, uint32", 0x00ff'ffff, 1 );
    //    bench<vecidx::vector_index, uint64_t>( "vecidx::vector_index, uint64", 0x00ff'ffff, 1 );

    //    std::cout << "\n";
    //    bench<vecidx::search_index, uint32_t>( "vecidx::search_index, uint32", 0x00ff'ffff, 1 );
    //    bench<vecidx::search_index, uint64_t>( "vecidx::search_index, uint64", 0x00ff'ffff, 1 );
    //}
    return 0;
}
